...
@IdClass(BookLibraryBranch.class)
public class Copies implements Serializable {
    ...
    public boolean equals(Object o) {
        ...
        return getCopiesAmount() == copies.getCopiesAmount() &&
                getBook().equals(copies.getBook()) &&
    ...
    public String toString() {
        return new StringJoiner(", ", Copies.class.getSimpleName() + "[", "]")
                .add("bookId=" + book.getBookId())
                .add("branchId=" + branch.getBranchId())
                .add("amount=" + copiesAmount)
                .toString();
    }
}