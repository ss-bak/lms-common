...
public class Book implements Serializable {
    ...
    public String toString() {
        return new StringJoiner(", ", Book.class.getSimpleName() + "[", "]")
                ...
                .add("authorSet=" + bookAuthorSet.stream()
                        .map(author -> Long.toString(author.getAuthorId()))
                        .collect(Collectors.joining(",", "[", "]")))
                .add("genreSet=" + bookGenreSet.stream()
                        .map(genre -> Long.toString(genre.getGenreId()))
                        .collect(Collectors.joining(",", "[", "]")))
                .toString();
    }
}